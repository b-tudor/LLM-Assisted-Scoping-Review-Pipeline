...
# id,title,abstract
# As input, it requires the files "title-abstract-list.csv" and "title"
...
if (argc != 2):
    ...
    print(f'\nJSONL data is output directly to the terminal. To create your batch')
    print(f'file, redirect this output to a JSONL file.\nE.g.:')
    print(f'\t{sys.argv[0]} title-abstract-list.csv > batch-title-abs-screen.jsonl')
    print(f'\nThe input file should be a CSV file with columns labeled "id",')
    print(f'\n"title, and "abstract".')
    exit(1)
