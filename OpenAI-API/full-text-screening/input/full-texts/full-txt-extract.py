...
# Your Mac paths
PDF_FOLDER    = Path("/mnt/u/brant/Code/JHACH/HDT-review-review/PDFs")
OUTPUT_FOLDER = Path("/mnt/u/brant/Code/JHACH/HDT-review-review/full-text")
...
for pdf_file in PDF_FOLDER.glob("*.pdf"):
    ...
    paragraphs = [p.text for p in root.findall(".//tei:p", ns) if p.text]
    txt_path = OUTPUT_FOLDER / (pdf_file.stem + ".txt")
    txt_path.write_text("\n\n".join(paragraphs), encoding="utf-8")
 
    print(f"✅ Saved: {tei_path} and {txt_path}")
